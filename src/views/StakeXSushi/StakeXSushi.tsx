    ...
    <>
      <StyledFarm>
        ...
        <StyledCardsWrapper>
          <StyledCardWrapper>
          <StyledInfo>
            Users who stake BSCX in BSCXSafe will receive xBSCX LP tokens which represent their proportion of BSCX staked. Stakers will need to withdraw their xBSCX LP tokens in order to receive their BSCX reward.
          </StyledInfo>
          </StyledCardWrapper>
        </StyledCardsWrapper>
      </StyledFarm>
